...
run('handbook-render', 'node', ['node_modules/tsx/dist/cli.mjs', '--tsconfig', 'tsconfig.app.json', 'scripts/prerender-handbook.tsx']);
run('handbook-audit', 'node', ['scripts/audit-handbook.mjs']);
run('site-artifact-audit', 'node', ['scripts/audit-site-artifact.mjs']);
...
const pyScripts = [
  ...
  'scripts/selective-checkpoint.py',
  'scripts/research_experiment.py',
  'scripts/run-research-experiment.py',
  'scripts/download-research-model.py',
  'scripts/export-research-report.py',
  'scripts/verify-research-run.py',
  'scripts/refresh-research-catalog.py',
  'scripts/validate-research-refresh.py',
  'scripts/test-selective-tools.py',
