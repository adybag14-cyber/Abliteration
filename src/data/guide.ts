...
export const techniques: Technique[] = [
  ...
  { id: "T08", title: "MoE per-expert edit", tier: "Production", summary: "Apply the T03 stack to each expert output projection. A shared-MLP-only pass leaves refusal in inactive experts.", when: "Mixtral, Qwen3-MoE, Phi-MoE, or Granite hybrids", tags: ["MoE", "hybrid", "per-expert"], doc: "techniques/moe-hybrid-abliteration.md" },
  ...
  { id: "T31", title: "Router-weighted MoE diagnostics", tier: "Frontier", summary: "Measure expert utilization and routing shift around per-expert edits.", when: "Working with routed expert models", tags: ["MoE", "routing"], doc: "techniques/advanced-experimental-methods.md" },
