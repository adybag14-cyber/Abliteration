...
- [../techniques/extended-abliteration-toolkit.md](../techniques/extended-abliteration-toolkit.md) — Abliterix / ErisForge / jim-plus (`measure.py --deccp` topics) when defenses limit single-pass
