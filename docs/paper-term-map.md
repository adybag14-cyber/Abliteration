...
| **COSMIC** | Siu et al. ACL 2025, 2506.00085 | [techniques/cosmic-refusal-direction.md](../techniques/cosmic-refusal-direction.md) · [methods/cosmic-direction-id.md](../methods/cosmic-direction-id.md) | `--mode cosmic` |
| **false-refusal** / over-refusal | Wang et al. 2410.03415 · T38 | [techniques/false-refusal-vector-ablation.md](../techniques/false-refusal-vector-ablation.md) | Paper: `w′ = w − λ v_true` (need a harmful set for `v`). Raw factory DIM is the failure mode in Table 1 |
