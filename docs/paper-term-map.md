...
| **C++26 lab** | this repo | [cxx26-researcher-guide.md](cxx26-researcher-guide.md) | `guide` → `doctor` → `limits` → `self-check` → `demo` on [cxx-nightly](https://github.com/adybag14-cyber/Abliteration/releases/tag/cxx-nightly) |
