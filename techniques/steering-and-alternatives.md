...
| Better GSM8K preservation (single-pass) | **ErisForge** or jim-plus `measure.py --deccp` (Young’s “DECCP” is not a peer CLI) — see [comparative-abliteration-benchmarks.md](../docs/comparative-abliteration-benchmarks.md) |
