...
COMPILER="${3:-}"
NAME="${3:-$TRIPLE}"
DEST="$ROOT/cxx/dist/abliterate-cxx-$NAME"
mkdir -p "$DEST"
EXE=""
...
{
  echo "package=abliterate-cxx-$NAME"
...
tar -C "$ROOT/cxx/dist" -czf "$ROOT/cxx/dist/abliterate-cxx-$NAME.tar.gz" "abliterate-cxx-$NAME"
echo "wrote $ROOT/cxx/dist/abliterate-cxx-$NAME.tar.gz"
